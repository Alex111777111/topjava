    ...
    <%--<h3><a href="${pageContext.request.contextPath}">Home</a></h3>--%>
          <h3><fmt:message key="meals.title"/></h3>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" name="startTime" id="startTime" class="time-picker">
                </div>

                <label class="control-label col-sm-2" for="endTime">To Time:</label>

                <div class="col-sm-2">
                    <input type="text" name="endTime" id="endTime" class="time-picker">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-8">
                    <button id="filterSubmit" type="submit" class="btn btn-primary pull-right">Filter</button>
                </div>
            </div>
            <div>
                <input type="hidden" name="_csrf" value="d23572e7-4a39-487e-a547-3e84a8c1c825">
            </div></form>
